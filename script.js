const CANVAS_W = 1080;
        ...
        // Fixed Panimalar Assets & Texts (UPDATED FOR EXACT MATCH)
        ...
        function drawAllElements(targetCtx) {
            ...
            // FULLY REWRITTEN TO MATCH REQUIRED VISUAL HIERARCHY EXACTLY
    ...
    ctx.restore();
        ...
        function drawCongratulations(ctx, startY) {
            ...
            ctx.letterSpacing = "4px";
            ctx.textAlign = 'center';
            const subText = "PROUD OF YOUR ACHIEVEMENT".split('').join(String.fromCharCode(8201));
            ctx.fillText(subText, CANVAS_W / 2, cy);
        }
            ...
            if (count > 0) {
                ...
                for (let r = 0; r < rows; r++) {
                    ...
                    for (let c = 0; c < rowItems; c++) {
                        let name = names[startIdx + c]; // Removed hardcoded MR. prefix
